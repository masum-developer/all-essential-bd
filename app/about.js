    ...
    return (
        <View style={styles.container}>
            ...
            <Text style={styles.description}>
                Welcome to our app! We are dedicated to serve daily needs. Our team is passionate about delivering high-quality products to our users.
            </Text>
            ...
            <Text style={styles.contactInfo}>Contact Us: allessentialbd@gmail.com</Text>
        </View>
    );
};
