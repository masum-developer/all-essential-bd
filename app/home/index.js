        ...
        <ScrollView style={{ flex: 1, backgroundColor: 'black' }}>
            ...
            <View style={{ padding: 20 }}>
                ...
                <Text style={{ textAlign: 'justify', marginVertical: 20, color: 'white' }}>
                    ...
                    Explore our diverse collection of daily essentials, carefully curated to meet your household requirements. From fresh groceries to household cleaning supplies, we've got you covered. Say goodbye to the hassle of multiple trips to the store and embrace the simplicity of online shopping.
                    ...
                    Feel free to customize the text to better fit the specifics of your ecommerce platform and the products you offer.
